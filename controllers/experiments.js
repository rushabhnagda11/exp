                ...
                .then((expData) => {
                    expData.forEach((outputStr) => {
                        ...
                        if(!err) {
                            ...
                            db.Experiment.update({score : output.accuracy}, {where : {id : expObj.id}})
...
exports.runTest = (req, res, next) => {
    ...
    db.Model.find({
        ...
        console.log(JSON.stringify(data.Experiments[0].Parameter.learningRate))
